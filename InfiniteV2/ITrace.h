...
{
public:
	void clip_trace_to_players(Vec3& start, Vec3& end, CTraceFilter* filter, CGameTrace* trace, float min, float max, float length)
	{
	...
	void trace_shape(Ray* ray, Vec3& start, Vec3& end, CTraceFilter* filter, CGameTrace* trace)
	{
